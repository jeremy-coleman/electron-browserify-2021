...
const mapFileCommentRegex = new RegExp(/(?:\/\/[@#][ \t]+sourceMappingURL=([^\s'"`]+?)[ \t]*$)|(?:\/\*[@#][ \t]+sourceMappingURL=([^\*]+?)[ \t]*(?:\*\/){1}[ \t]*$)/mg);
...
class Converter {
    constructor(sm, opts = {}) {
        ...
        this.toComment = function (options) {
...
module.exports = { fromComment, create, removeComments, dedent, convert, offsetSourceMaps, merge };
